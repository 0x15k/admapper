...
ENGAGEMENT_FRAMEWORK = (
    "Unified AD chain — CRTP (core) · CRTE (advanced) · CRTO (operator loop) · MITRE (tags)"
)
...
UNIFIED_PHASES: tuple[PhaseDef, ...] = (
    PhaseDef(
        ...
        1,
        "Scope",
        "Workspace, target DC, Kerberos clock, /etc/hosts",
        (),
        "—",
        "—",
        "Engagement planning",
    ...
    PhaseDef(
        ...
        2,
        "Unauth discovery",
        "Domain, DC, ports, LDAP/SMB/Kerberos without creds",
        ("Reconnaissance",),
    ...
    PhaseDef(
        ...
        3,
        "Identity surface",
        "Users, SPNs, AS-REP roastable, lockout policy",
        ("Reconnaissance", "Discovery"),
        "Domain enumeration (without cred)",
        "Deep pre-auth enum",
    ...
    PhaseDef(
        ...
        4,
        "Credential access",
        "AS-REP, Kerberoast, spray, GPP, SMB loot",
        ("Credential Access",),
        "Kerberoast / spray / AS-REP",
        "Timeroast, advanced GPP",
        "Credential theft",
    ...
    PhaseDef(
        ...
        5,
        "Foothold",
        "First valid credential and initial owned",
        ("Initial Access",),
        "Assumed breach",
        "—",
    ...
    PhaseDef(
        ...
        6,
        "Domain enumeration",
        "Authenticated LDAP/SMB, trusts, delegations, BloodHound",
        ("Discovery",),
        "Module I — domain enum",
    ...
    PhaseDef(
        ...
        "Graph, paths to DA/EA, quick wins, next hop",
        ("Discovery",),
    ...
    PhaseDef(
        ...
        "ACL abuse, advanced Kerberos, AD CS, domain CVEs",
        ("Privilege Escalation",),
        "Module II — domain priv esc",
        "Enterprise Modules I–III",
        "Escalate on domain",
        "acl_findings.json",
    ...
    PhaseDef(
        ...
        9,
        "Coercion & relay",
        "PetitPotam, PrinterBug, NTLM relay to AD CS / LDAP",
    ...
    PhaseDef(
        ...
        10,
        "Lateral movement",
        "WinRM, PtH/PtT, MSSQL, remote post-ex, AdminTo",
        ("Lateral Movement",),
        "Module II — lateral",
        "JEA / LAPS bypass",
        "Lateral movement",
    ...
    PhaseDef(
        ...
        12,
        "Reporting",
        "Engagement map, MITRE Navigator, HTML report",
        (),
        "—",
        "—",
...
OPS_PHASES: tuple[PhaseDef, ...] = (
    ...
    PhaseDef(
        ...
        "IDENT",
        "Identity surface",
        "Users · SPN · AS-REP · lockout",
        ("p03",),
        "brief",
        "ENUM USERS",
        "enum users (after scan)",
    ),
    PhaseDef(
        "g04",
        "CREDS",
...
def methodology_progress_lines(ws_path: Path) -> list[str]:
    ...
    lines: list[str] = ["", "  AD CHAIN (P1–P12)"]
    for ph in UNIFIED_PHASES:
